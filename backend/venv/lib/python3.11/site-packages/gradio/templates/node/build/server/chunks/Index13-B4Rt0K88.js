...
import { B as Block, S as Static, f as BlockLabel, N as Code$2, h as Empty, j as IconButton, w as Copy$1, D as Download$1, i as IconButtonWrapper } from './2-DguXXTWD.js';
...
const lang_map = {
  python: () => import('./index28-S21PWTyt.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index29-CVAj7vSF.js'),
      import('./frontmatter-CXMYzvMa.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index33-DkGUkhM1.js').then((m) => m.json()),
  html: () => import('./index30-DPQEGpGe.js').then((m) => m.html()),
  css: () => import('./index31-DtpjFn0G.js').then((m) => m.css()),
  javascript: () => import('./index32-BiUowLWp.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index32-BiUowLWp.js').then(
...
//# sourceMappingURL=Index13-B4Rt0K88.js.map
