...
import { B as Block, S as Static, t as MarkdownCode, O as Minimize, P as Maximize } from './2-DguXXTWD.js';
import { d as dequal } from './index6-sfNUnwRZ.js';
import { U as Upload } from './ModifyUpload-DWUmJP82.js';
...
const css$4 = {
  code: "input.svelte-1e50zov{position:absolute;top:var(--size-2);right:var(--size-2);bottom:var(--size-2);left:var(--size-2);flex:1 1 0%;transform:translateX(-0.1px);outline:none;border:none;background:transparent;cursor:text}span.svelte-1e50zov{flex:1 1 0%;outline:none;padding:var(--size-2);-webkit-user-select:text;-moz-user-select:text;-ms-user-select:text;user-select:text;cursor:text}.header.svelte-1e50zov{transform:translateX(0);font-weight:var(--weight-bold)}.edit.svelte-1e50zov{opacity:0;pointer-events:none}",
  map: '{"version":3,"file":"EditableCell.svelte","sources":["EditableCell.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { createEventDispatcher } from \\"svelte\\";\\nimport { MarkdownCode } from \\"@gradio/markdown-code\\";\\nexport let edit;\\nexport let value = \\"\\";\\nexport let display_value = null;\\nexport let styling = \\"\\";\\nexport let header = false;\\nexport let datatype = \\"str\\";\\nexport let latex_delimiters;\\nexport let clear_on_focus = false;\\nexport let line_breaks = true;\\nexport let editable = true;\\nexport let root;\\nconst dispatch = createEventDispatcher();\\nexport let el;\\n$: _value = value;\\nfunction use_focus(node) {\\n    if (clear_on_focus) {\\n        _value = \\"\\";\\n    }\\n    requestAnimationFrame(() => {\\n        node.focus();\\n    });\\n    return {};\\n}\\nfunction handle_blur({ currentTarget }) {\\n    value = currentTarget.value;\\n    dispatch(\\"blur\\");\\n}\\nfunction handle_keydown(event) {\\n    if (event.key === \\"Enter\\") {\\n        value = _value;\\n        dispatch(\\"blur\\");\\n    }\\n    dispatch(\\"keydown\\", event);\\n}\\n<\/script>\\n\\n{#if edit}\\n\\t<input\\n\\t\\trole=\\"textbox\\"\\n\\t\\tbind:this={el}\\n\\t\\tbind:value={_value}\\n\\t\\tclass:header\\n\\t\\ttabindex=\\"-1\\"\\n\\t\\ton:blur={handle_blur}\\n\\t\\ton:mousedown|stopPropagation\\n\\t\\ton:mouseup|stopPropagation\\n\\t\\ton:click|stopPropagation\\n\\t\\tuse:use_focus\\n\\t\\ton:keydown={handle_keydown}\\n\\t/>\\n{/if}\\n\\n<span\\n\\ton:dblclick\\n\\ttabindex=\\"-1\\"\\n\\trole=\\"button\\"\\n\\tclass:edit\\n\\ton:focus|preventDefault\\n\\tstyle={styling}\\n\\tclass=\\"table-cell-text\\"\\n\\tplaceholder=\\" \\"\\n>\\n\\t{#if datatype === \\"html\\"}\\n\\t\\t{@html value}\\n\\t{:else if datatype === \\"markdown\\"}\\n\\t\\t<MarkdownCode\\n\\t\\t\\tmessage={value.toLocaleString()}\\n\\t\\t\\t{latex_delimiters}\\n\\t\\t\\t{line_breaks}\\n\\t\\t\\tchatbot={false}\\n\\t\\t\\t{root}\\n\\t\\t/>\\n\\t{:else}\\n\\t\\t{editable ? value : display_value || value}\\n\\t{/if}\\n</span>\\n\\n<style>\\n\\tinput {\\n\\t\\tposition: absolute;\\n\\t\\ttop: var(--size-2);\\n\\t\\tright: var(--size-2);\\n\\t\\tbottom: var(--size-2);\\n\\t\\tleft: var(--size-2);\\n\\t\\tflex: 1 1 0%;\\n\\t\\ttransform: translateX(-0.1px);\\n\\t\\toutline: none;\\n\\t\\tborder: none;\\n\\t\\tbackground: transparent;\\n\\t\\tcursor: text;\\n\\t}\\n\\n\\tspan {\\n\\t\\tflex: 1 1 0%;\\n\\t\\toutline: none;\\n\\t\\tpadding: var(--size-2);\\n\\t\\t-webkit-user-select: text;\\n\\t\\t-moz-user-select: text;\\n\\t\\t-ms-user-select: text;\\n\\t\\tuser-select: text;\\n\\t\\tcursor: text;\\n\\t}\\n\\n\\t.header {\\n\\t\\ttransform: translateX(0);\\n\\t\\tfont-weight: var(--weight-bold);\\n\\t}\\n\\n\\t.edit {\\n\\t\\topacity: 0;\\n\\t\\tpointer-events: none;\\n\\t}</style>\\n"],"names":[],"mappings":"AAgFC,oBAAM,CACL,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,QAAQ,CAAC,CAClB,KAAK,CAAE,IAAI,QAAQ,CAAC,CACpB,MAAM,CAAE,IAAI,QAAQ,CAAC,CACrB,IAAI,CAAE,IAAI,QAAQ,CAAC,CACnB,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,EAAE,CACZ,SAAS,CAAE,WAAW,MAAM,CAAC,CAC7B,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,WAAW,CACvB,MAAM,CAAE,IACT,CAEA,mBAAK,CACJ,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,EAAE,CACZ,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,QAAQ,CAAC,CACtB,mBAAmB,CAAE,IAAI,CACzB,gBAAgB,CAAE,IAAI,CACtB,eAAe,CAAE,IAAI,CACrB,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,IACT,CAEA,sBAAQ,CACP,SAAS,CAAE,WAAW,CAAC,CAAC,CACxB,WAAW,CAAE,IAAI,aAAa,CAC/B,CAEA,oBAAM,CACL,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IACjB"}'
};
const EditableCell = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  _value = value;
  return `${edit ? `<input role="textbox" tabindex="-1" class="${["svelte-1e50zov", header ? "header" : ""].join(" ").trim()}"${add_attribute("this", el, 0)}${add_attribute("value", _value, 0)}>` : ``} <span tabindex="-1" role="button"${add_attribute("style", styling, 0)} class="${["table-cell-text svelte-1e50zov", edit ? "edit" : ""].join(" ").trim()}" placeholder=" ">${datatype === "html" ? `<!-- HTML_TAG_START -->${value}<!-- HTML_TAG_END -->` : `${datatype === "markdown" ? `${validate_component(MarkdownCode, "MarkdownCode").$$render(
    $$result,
    {
      message: value.toLocaleString(),
      latex_delimiters,
...
const Table = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = ` <div class="table-container svelte-1l6bino"><div class="header-row svelte-1l6bino">${label && label.length !== 0 && show_label ? `<div class="label svelte-1l6bino"><p class="svelte-1l6bino">${escape(label)}</p></div>` : ``} ${validate_component(Toolbar, "Toolbar").$$render($$result, { show_fullscreen_button, is_fullscreen }, {}, {})}</div> <div class="${[
      "table-wrap svelte-1l6bino",
      (dragging ? "dragging" : "") + " " + (!wrap ? "no-wrap" : "")
    ].join(" ").trim()}" style="${"height:" + escape(table_height, true) + "px"}" role="grid" tabindex="0"${add_attribute("this", parent, 0)}><table class="${["svelte-1l6bino", column_widths.length != 0 ? "fixed-layout" : ""].join(" ").trim()}"${add_attribute("this", table, 0)}>${label && label.length !== 0 ? `<caption class="sr-only">${escape(label)}</caption>` : ``} <thead class="svelte-1l6bino"><tr class="svelte-1l6bino">${show_row_numbers ? `<th class="row-number-header svelte-1l6bino"></th>` : ``} ${each(_headers, ({ value, id }, i) => {
      return `<th${add_attribute("aria-sort", get_sort_status(), 0)} class="${["svelte-1l6bino", header_edit === i ? "editing" : ""].join(" ").trim()}"${add_styles({
        "width": column_widths.length ? column_widths[i] : void 0
      })}><div class="cell-wrap svelte-1l6bino">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
        ...
        "sort-button " + escape(sort_direction, true) + " svelte-1l6bino",
        (sort_by === i ? "sorted" : "") + " " + (sort_by === i && sort_direction === "des" ? "des" : "")
      ].join(" ").trim()}"><svg width="1em" height="1em" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-1l6bino"><path d="M4.49999 0L8.3971 6.75H0.602875L4.49999 0Z"></path></svg> </div></div> </th>`;
    })}</tr></thead> <tbody><tr class="svelte-1l6bino">${each(max, ({ value, id }, j) => {
      return `<td tabindex="-1" class="svelte-1l6bino"${add_attribute("this", cells[j], 0)}><div class="cell-wrap svelte-1l6bino">${validate_component(EditableCell, "EditableCell").$$render(
        $$result,
        {
          value,
          latex_delimiters,
      ...
      },
      {
        default: () => {
          return `${validate_component(VirtualTable, "VirtualTable").$$render(
            ...
            {
              tbody: ({ index, item }) => {
                return `<tr slot="tbody" class="${["svelte-1l6bino", index % 2 === 0 ? "row_odd" : ""].join(" ").trim()}">${show_row_numbers ? `<td class="row-number svelte-1l6bino"${add_attribute("title", `Row ${index + 1}`, 0)}>${escape(index + 1)}</td>` : ``} ${each(item, ({ value, id }, j) => {
                  return `<td tabindex="0"${add_styles(merge_ssr_styles(escape(styling?.[index]?.[j] || "", true), { "width": `var(--cell-width-${j})` }))} class="${[
                  ...
                  ].join(" ").trim()}"><div class="cell-wrap svelte-1l6bino">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      display_value: display_value?.[index]?.[j],
                      latex_delimiters,
                    ...
                    {}
                  )} ${editable ? `<button class="cell-menu-button svelte-1l6bino" data-svelte-h="svelte-b4o3eq">⋮
									</button>` : ``}</div> </td>`;
                })}</tr>`;
              },
              thead: () => {
                return `<tr slot="thead" class="svelte-1l6bino">${show_row_numbers ? `<th class="row-number-header svelte-1l6bino"></th>` : ``} ${each(_headers, ({ value, id }, i) => {
                  return `<th${add_attribute("aria-sort", get_sort_status(), 0)} style="${"width: var(--cell-width-" + escape(i, true) + ");"}" class="${[
                  ...
                  ].join(" ").trim()}"><div class="cell-wrap svelte-1l6bino"><div class="header-content svelte-1l6bino">${validate_component(EditableCell, "EditableCell").$$render(
                    $$result,
                    {
                      latex_delimiters,
                      line_breaks,
                    ...
                    "sort-button " + escape(sort_direction, true) + " svelte-1l6bino",
                    (sort_by === i ? "sorted" : "") + " " + (sort_by === i && sort_direction === "des" ? "des" : "")
                  ].join(" ").trim()}" tabindex="0"><svg width="1em" height="1em" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-1l6bino"><path d="M4.49999 0L8.3971 6.75H0.602875L4.49999 0Z"></path></svg> </button></div> ${editable ? `<button class="cell-menu-button svelte-1l6bino" data-svelte-h="svelte-1e92k9i">⋮
									</button>` : ``}</div> </th>`;
                })}</tr>`;
              },
              default: () => {
...
//# sourceMappingURL=Index55-DtazYdWA.js.map
